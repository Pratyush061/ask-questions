...
QUESTION_BANK = [
    Question(
        "What does this app use to find your hand in the camera feed?",
        ["MediaPipe", "TensorFlow.js", "PyTorch", "scikit-learn"],
        answer=1,
    ),
    Question(
        "How many landmarks does MediaPipe track per hand?",
        ["10", "21", "35", "50"],
        answer=2,
    ),
    Question(
        "How many hands can this tracker watch at the same time?",
        ["Exactly 1", "2 (both hands)", "5", "Only webcams with depth sensors"],
        answer=2,
    ),
    Question(
        "OpenCV stores color images in which channel order by default?",
        ["RGB", "RGBA", "BGR", "HSV"],
        answer=3,
    ),
    Question(
        "Which landmark index is the tip of the index finger?",
        ["4", "8", "12", "20"],
        answer=2,
    ),
    Question(
        "Roughly how fast does MediaPipe hand tracking run on a laptop CPU?",
        ["~1 frame per minute", "~1 frame per second", "Real time (30+ FPS)", "It needs a GPU cluster"],
        answer=3,
    ),
    Question(
        "What colour does this app draw on a locked-in correct answer?",
        ["Green", "Blue", "Red", "Yellow"],
        answer=1,
    ),
    Question(
        "How do you answer a question in this quiz?",
        ["Say it out loud", "Type it", "Hold up fingers", "Blink twice"],
        answer=3,
    ),
]
